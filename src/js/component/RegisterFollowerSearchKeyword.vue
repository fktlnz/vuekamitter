<template>    
    <div v-if=" show===true " class="l-subPage l-searchKeyPage">
        <Message></Message>
        <div class="u-txt_center"><button v-on:click="moveTop" class="c-btn c-moveTop"><i class="fas fa-home c-icon-home"></i>HOME</button><span class="c-title p-heading__follow">フォロワーサーチキーワード登録</span></div>        
        <div>            
